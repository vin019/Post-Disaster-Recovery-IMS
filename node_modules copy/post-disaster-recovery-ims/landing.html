    ...
    <script>
                ...
                loginUser(username, password)
                    .then(data => {
                        if (data.role === 'admin') {
                            ...
                            // Fallback for generic users or beneficiaries if not handled above
                             alertMessage("Login successful (Viewer Mode).", "info");
                             hideModal();
                             switchToViewer();
                        }
                    })
        ...
        function handleStep2Submit(event, isMember) {
            ...
            const finalUserData = {
                ...
                name: `${signupData.surname}, ${signupData.firstName} ${signupData.middleInitial}.`,
                email: signupData.email,
                contactNumber: signupData.contact,
                age: signupData.age, 
            };
            if (isMember) {
                finalUserData.purok = signupData.purok;
                finalUserData.isHead = signupData.isHead;
                finalUserData.householdHead = signupData.householdHead;
            }
